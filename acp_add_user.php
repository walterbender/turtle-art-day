...
* @package acp
* @version $Id:
* @copyright (c) 2012 phpBB Modders
	...
	function main($id, $mode)
	{
		...
		if ($submit)
		{
			...
			if (!sizeof($error))
			{
				...
				$message[] = sprintf($user->lang['EDIT_USER_GROUPS'], '<a href="' . append_sid("{$phpbb_admin_path}index.$phpEx", 'i=users&amp;mode=groups&amp;u=' . $user_id) . '">', $data['username'], '</a>');
